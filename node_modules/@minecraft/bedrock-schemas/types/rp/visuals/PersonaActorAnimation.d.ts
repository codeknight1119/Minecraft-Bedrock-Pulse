...
/**
 * Persona Actor Animation (v1.8.0) (persona_actor_animation)
 * Defines a persona actor animation document with format_version 
 * 1.8.0.
 */
export default interface PersonaActorAnimation {

  animations: { [key: string]: PersonaActorAnimationAnimations };
...
export interface PersonaActorAnimationAnimations {
  ...
  bones?: { [key: string]: PersonaActorAnimationAnimationsBones };
  ...
  particle_effects?: { [key: string]: PersonaActorAnimationAnimationsParticleEffects };
   ...
   * time
   */
  sound_effects?: { [key: string]: PersonaActorAnimationAnimationsSoundEffects };
  ...
  timeline?: { [key: string]: PersonaActorAnimationAnimationsTimeline };
...
export interface PersonaActorAnimationAnimationsBones {
  ...
  position?: { [key: string]: PersonaActorAnimationAnimationsBonesPosition };

  relative_to?: PersonaActorAnimationAnimationsBonesRelativeTo;

  rotation?: { [key: string]: PersonaActorAnimationAnimationsBonesRotation };

  scale?: { [key: string]: PersonaActorAnimationAnimationsBonesScale };
