...
/**
 * Animation Controller (v1.10.0) (actor_animation_controller)
 * Animation controllers are state machines that control which
 * animations play and when. They support states with animations,
 * transitions based on Molang conditions, particle effects, and
 * sound effects. Each state can blend between animations and
 * trigger events on entry and exit.
 */
export default interface ActorAnimationController {

  animation_controllers: { [key: string]: ActorAnimationControllerAnimationControllers };
...
export interface ActorAnimationControllerAnimationControllers {
  ...
  states: { [key: string]: ActorAnimationControllerAnimationControllersStates };
...
export interface ActorAnimationControllerAnimationControllersStates {
  ...
  variables?: { [key: string]: ActorAnimationControllerAnimationControllersStatesVariables };
