...
/**
 * Render Controller (v1.8.0) (render_controller)
 * Render controllers define how entities are visually rendered,
 * including which geometry, textures, and materials to use. They
 * support arrays for dynamic selection based on Molang expressions, part
 * visibility toggling, UV animations, and color tinting.
 */
export default interface RenderController {

  format_version: string | number[];

  render_controllers: { [key: string]: RenderControllerRenderControllers };
...
export interface RenderControllerRenderControllersArrays {
  ...
  geometries?: { [key: string]: RenderControllerRenderControllersArraysGeometries };

  materials?: { [key: string]: RenderControllerRenderControllersArraysMaterials };

  textures?: { [key: string]: RenderControllerRenderControllersArraysTextures };
