...
/**
 * Actor Animation (v1.8.0) (actor_animation)
 * Defines keyframe animations for entity bones. Animations can
 * transform bones with position, rotation, and scale changes over
 * time. They support timeline-based keyframes, Molang expressions, looping,
 * and can be blended together using animation controllers.
 */
export default interface ActorAnimation {

  animations: { [key: string]: ActorAnimationAnimations };
...
export interface ActorAnimationAnimations {
  ...
  bones?: { [key: string]: ActorAnimationAnimationsBones };
  ...
  particle_effects?: { [key: string]: ActorAnimationAnimationsParticleEffects };
   ...
   * time
   */
  sound_effects?: { [key: string]: ActorAnimationAnimationsSoundEffects };
  ...
  timeline?: { [key: string]: ActorAnimationAnimationsTimeline };
...
export interface ActorAnimationAnimationsBones {
  ...
  position?: { [key: string]: ActorAnimationAnimationsBonesPosition };

  relative_to?: ActorAnimationAnimationsBonesRelativeTo;

  rotation?: { [key: string]: ActorAnimationAnimationsBonesRotation };

  scale?: { [key: string]: ActorAnimationAnimationsBonesScale };
