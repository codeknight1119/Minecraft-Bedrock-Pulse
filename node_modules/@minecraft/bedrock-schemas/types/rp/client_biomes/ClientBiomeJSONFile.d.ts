 ...
 * Defines the client-side visual and audio properties of a
 * biome. Client biomes control fog, water color, grass tint, ambient
 * sounds, and music within a biome. They are paired with
 * server-side biome definitions that control gameplay 
 * behavior.
 */
