 ...
 */
export default interface ParticleEffect {

  components: ParticleEffectComponents;

  curves?: ParticleEffectCurves;
 ...
 * pieces.
 */
export interface ParticleEffectComponents {

  "minecraft:emitter_initialization"?: ParticleEffectComponentsMinecraftEmitterInitialization;

  "minecraft:emitter_lifetime_events"?: object;

  "minecraft:emitter_lifetime_expression"?: ParticleEffectComponentsMinecraftEmitterLifetimeExpression;

  "minecraft:emitter_lifetime_looping"?: ParticleEffectComponentsMinecraftEmitterLifetimeLooping;

  "minecraft:emitter_lifetime_once"?: ParticleEffectComponentsMinecraftEmitterLifetimeOnce;

  "minecraft:emitter_local_space"?: object;

  "minecraft:emitter_rate_instant"?: ParticleEffectComponentsMinecraftEmitterRateInstant;

  "minecraft:emitter_rate_manual"?: ParticleEffectComponentsMinecraftEmitterRateManual;

  "minecraft:emitter_rate_steady"?: ParticleEffectComponentsMinecraftEmitterRateSteady;

  "minecraft:emitter_shape_box"?: ParticleEffectComponentsMinecraftEmitterShapeBox;

  "minecraft:emitter_shape_custom"?: ParticleEffectComponentsMinecraftEmitterShapeCustom;

  "minecraft:emitter_shape_disc"?: ParticleEffectComponentsMinecraftEmitterShapeDisc;

  "minecraft:emitter_shape_entity_aabb"?: ParticleEffectComponentsMinecraftEmitterShapeEntityAabb;

  "minecraft:emitter_shape_point"?: ParticleEffectComponentsMinecraftEmitterShapePoint;

  "minecraft:emitter_shape_sphere"?: ParticleEffectComponentsMinecraftEmitterShapeSphere;

  "minecraft:particle_appearance_billboard"?: ParticleEffectComponentsMinecraftParticleAppearanceBillboard;

  "minecraft:particle_appearance_lighting"?: object;

  "minecraft:particle_appearance_tinting"?: ParticleEffectComponentsMinecraftParticleAppearanceTinting;
  ...
  "minecraft:particle_initial_spin"?: ParticleEffectComponentsMinecraftParticleInitialSpin;

  "minecraft:particle_initialization"?: ParticleEffectComponentsMinecraftParticleInitialization;
  ...
  "minecraft:particle_lifetime_expression"?: ParticleEffectComponentsMinecraftParticleLifetimeExpression;

  "minecraft:particle_motion_collision"?: ParticleEffectComponentsMinecraftParticleMotionCollision;

  "minecraft:particle_motion_dynamic"?: ParticleEffectComponentsMinecraftParticleMotionDynamic;

  "minecraft:particle_motion_parametric"?: ParticleEffectComponentsMinecraftParticleMotionParametric;
 ...
 * variables.
 */
export interface ParticleEffectComponentsMinecraftEmitterInitialization {
 ...
 */
export interface ParticleEffectComponentsMinecraftEmitterLifetimeExpression {
 ...
 */
export interface ParticleEffectComponentsMinecraftEmitterLifetimeLooping {
 ...
 */
export interface ParticleEffectComponentsMinecraftEmitterLifetimeOnce {
 ...
 */
export interface ParticleEffectComponentsMinecraftEmitterRateInstant {
 ...
 */
export interface ParticleEffectComponentsMinecraftEmitterRateManual {
 ...
 */
export interface ParticleEffectComponentsMinecraftEmitterRateSteady {
 ...
 */
export interface ParticleEffectComponentsMinecraftEmitterShapeBox {
 ...
 */
export interface ParticleEffectComponentsMinecraftEmitterShapeCustom {
 ...
 */
export interface ParticleEffectComponentsMinecraftEmitterShapeDisc {
 ...
 */
export interface ParticleEffectComponentsMinecraftEmitterShapeEntityAabb {
 ...
 * source.
 */
export interface ParticleEffectComponentsMinecraftEmitterShapePoint {
 ...
 * distribution.
 */
export interface ParticleEffectComponentsMinecraftEmitterShapeSphere {
 ...
 */
export interface ParticleEffectComponentsMinecraftParticleAppearanceBillboard {
...
export enum ParticleEffectComponentsMinecraftParticleAppearanceBillboardFacingCameraMode {
 ...
 */
export interface ParticleEffectComponentsMinecraftParticleAppearanceTinting {
 ...
 */
export interface ParticleEffectComponentsMinecraftParticleInitialSpin {
 ...
 */
export interface ParticleEffectComponentsMinecraftParticleInitialization {
 ...
 */
export interface ParticleEffectComponentsMinecraftParticleLifetimeExpression {
 ...
 */
export interface ParticleEffectComponentsMinecraftParticleMotionCollision {
  ...
  events?: ParticleEffectComponentsMinecraftParticleMotionCollisionEvents[];
...
/**
 */
export interface ParticleEffectComponentsMinecraftParticleMotionCollisionEvents {
 ...
 */
export interface ParticleEffectComponentsMinecraftParticleMotionDynamic {
 ...
 */
export interface ParticleEffectComponentsMinecraftParticleMotionParametric {
 ...
 * Curves (curves)
 */
export interface ParticleEffectCurves {
 ...
 * basic_render_parameters.
 */
export interface ParticleEffectDescription {
 ...
 * particles.
 */
export interface ParticleEffectEvents {

  expression?: { [key: string]: string };

  log?: string;

  particle_effect?: ParticleEffectEventsParticleEffect;

  randomize?: ParticleEffectEventsRandomize[];

  sequence?: object[];

  sound_effect?: ParticleEffectEventsSoundEffect;
 ...
 * components.
 */
export interface ParticleEffectEventsParticleEffect {
...
export enum ParticleEffectEventsParticleEffectType {
  emitter = `emitter`,
 ...
 * logic.
 */
export interface ParticleEffectEventsRandomize {

  expression?: { [key: string]: string };

  log?: string;

  particle_effect?: ParticleEffectEventsRandomizeParticleEffect;

  randomize?: object[];

  sequence?: object[];

  sound_effect?: ParticleEffectEventsRandomizeSoundEffect;
 ...
 * components.
 */
export interface ParticleEffectEventsRandomizeParticleEffect {
...
export enum ParticleEffectEventsRandomizeParticleEffectType {
  emitter = `emitter`,
  emitterBound = `emitter_bound`,
  particle = `particle`,
  particleWithVelocity = `particle_with_velocity`
 ...
 * feedback.
 */
export interface ParticleEffectEventsRandomizeSoundEffect {
 ...
 * feedback.
 */
export interface ParticleEffectEventsSoundEffect {
