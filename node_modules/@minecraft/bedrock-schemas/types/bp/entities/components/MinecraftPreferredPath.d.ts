 ...
 * 
 * Entity Components Documentation - minecraft:preferred_path
 * 
...
/**
 */
export interface MinecraftPreferredPathPreferredPathBlocks {
  ...
  /**
   * @remarks
   * The cost value for these blocks during pathfinding. Lower costs
   * make paths more preferred.
   */
  cost?: number;
