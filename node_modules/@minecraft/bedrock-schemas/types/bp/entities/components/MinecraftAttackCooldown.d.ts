 ...
 * 
 * Entity Components Documentation - minecraft:attack_cooldown
 * 
...
export default interface MinecraftAttackCooldown {
  ...
  /**
   * @remarks
   * Event to be run when the cooldown is complete. Can be an object
   * with event and target properties, or a simple event string.
   */
  attack_cooldown_complete_event?: object;
