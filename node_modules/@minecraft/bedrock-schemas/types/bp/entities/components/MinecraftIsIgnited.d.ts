 ...
 * 
 * Entity Components Documentation - minecraft:is_ignited
 * 
 * minecraft:is_ignited Samples
...
/**
 * Is Ignited (minecraft:is_ignited)
 * Sets that this entity is currently on fire.
 */
export default interface MinecraftIsIgnited {
