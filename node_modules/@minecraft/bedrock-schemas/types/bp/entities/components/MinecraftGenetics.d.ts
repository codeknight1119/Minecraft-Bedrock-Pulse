 ...
 * 
 * Entity Components Documentation - minecraft:genetics
 * 
...
export interface MinecraftGeneticsGenes {
   ...
   * mobs will have a random number in this range assigned to them. Can
   * be a single integer or an object with range_min and range_max
   * properties.
   */
  allele_range?: number;
