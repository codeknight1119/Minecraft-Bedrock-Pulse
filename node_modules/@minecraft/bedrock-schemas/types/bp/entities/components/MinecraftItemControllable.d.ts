 ...
 * 
 * Entity Components Documentation - minecraft:item_controllable
 * 
...
export default interface MinecraftItemControllable {
  ...
  /**
   * @remarks
   * List of items that can be used to control this entity while
   * ridden. Can be a single string or an array of strings.
   * 
   * Sample Values:
   * Pig: "carrotOnAStick"
   *
