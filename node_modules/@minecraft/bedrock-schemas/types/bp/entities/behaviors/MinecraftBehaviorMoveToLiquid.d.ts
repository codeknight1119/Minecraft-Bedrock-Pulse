 ...
 * 
 * Entity Behaviors Documentation - minecraft:behavior.move_to_liquid
 * 
...
/**
 * Entity Move To Liquid Behavior 
 * (minecraft:behavior.move_to_liquid)
...
export enum MinecraftBehaviorMoveToLiquidControlFlags {
  jump = `jump`,
  look = `look`,
  move = `move`
}
...
export enum MinecraftBehaviorMoveToLiquidMaterialType {
  any = `Any`,
  lava = `Lava`,
  water = `Water`
}