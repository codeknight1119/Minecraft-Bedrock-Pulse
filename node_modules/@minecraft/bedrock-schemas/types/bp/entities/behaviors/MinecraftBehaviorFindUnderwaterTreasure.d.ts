 ...
 * 
 * Entity Behaviors Documentation - minecraft:behavior.find_underwater_treasure
 * 
...
/**
 * Entity Find Underwater Treasure Behavior
 * (minecraft:behavior.find_underwater_treasure)
...
export enum MinecraftBehaviorFindUnderwaterTreasureControlFlags {
  jump = `jump`,
  look = `look`,
  move = `move`
}