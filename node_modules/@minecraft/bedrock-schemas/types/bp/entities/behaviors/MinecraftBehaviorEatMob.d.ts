 ...
 * 
 * Entity Behaviors Documentation - minecraft:behavior.eat_mob
 * 
...
/**
 * Entity Eat Mob Behavior (minecraft:behavior.eat_mob)
...
export enum MinecraftBehaviorEatMobControlFlags {
  jump = `jump`,
  look = `look`,
  move = `move`
}