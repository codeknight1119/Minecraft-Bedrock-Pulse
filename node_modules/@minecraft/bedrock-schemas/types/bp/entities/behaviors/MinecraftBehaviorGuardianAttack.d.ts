 ...
 * 
 * Entity Behaviors Documentation - minecraft:behavior.guardian_attack
 * 
...
/**
 * Entity Guardian Attack Behavior 
 * (minecraft:behavior.guardian_attack)
...
export enum MinecraftBehaviorGuardianAttackControlFlags {
  jump = `jump`,
  look = `look`,
  move = `move`
}