 ...
 * 
 * Entity Behaviors Documentation - minecraft:behavior.jump_around_target
 * 
...
export default interface MinecraftBehaviorJumpAroundTarget {
   ...
   *
   */
  filters?: MinecraftBehaviorJumpAroundTargetFilters;
...
export enum MinecraftBehaviorJumpAroundTargetControlFlags {
  jump = `jump`,
  look = `look`,
  move = `move`
}
 ...
 * Filters (filters)
 */
export interface MinecraftBehaviorJumpAroundTargetFilters {
