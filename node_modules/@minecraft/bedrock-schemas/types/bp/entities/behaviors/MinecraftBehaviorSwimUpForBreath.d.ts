 ...
 * 
 * Entity Behaviors Documentation - minecraft:behavior.swim_up_for_breath
 * 
...
/**
 * Entity Swim Up For Breath Behavior
 * (minecraft:behavior.swim_up_for_breath)
...
export enum MinecraftBehaviorSwimUpForBreathControlFlags {
  jump = `jump`,
  look = `look`,
  move = `move`
}