 ...
 * 
 * Entity Behaviors Documentation - minecraft:behavior.timer_flag_2
 * 
...
export default interface MinecraftBehaviorTimerFlag2 {
   ...
   *
   */
  on_end?: MinecraftBehaviorTimerFlag2OnEnd;

  /**
   * @remarks
   * Event(s) to run when the goal starts.
   */
  on_start?: MinecraftBehaviorTimerFlag2OnStart;
...
export enum MinecraftBehaviorTimerFlag2ControlFlags {
  jump = `jump`,
  look = `look`,
  move = `move`
}
 ...
 * gameplay.
 */
export interface MinecraftBehaviorTimerFlag2OnEnd {
   ...
   */
  filters?: MinecraftBehaviorTimerFlag2OnEndFilters;
 ...
 * Filters (filters)
 */
export interface MinecraftBehaviorTimerFlag2OnEndFilters {
...
export enum MinecraftBehaviorTimerFlag2OnEndTarget {
  baby = `baby`,
  block = `block`,
  damager = `damager`,
  holder = `holder`,
 ...
 * gameplay.
 */
export interface MinecraftBehaviorTimerFlag2OnStart {
   ...
   * combination of these objects.
   */
  filters?: MinecraftBehaviorTimerFlag2OnStartFilters;
 ...
 * Filters (filters)
 */
export interface MinecraftBehaviorTimerFlag2OnStartFilters {
...
export enum MinecraftBehaviorTimerFlag2OnStartTarget {
  baby = `baby`,
  block = `block`,
  damager = `damager`,
  holder = `holder`,
