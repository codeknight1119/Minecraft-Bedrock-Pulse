 ...
 * 
 * Entity Behaviors Documentation - minecraft:behavior.controlled_by_player
 * 
...
/**
 * Entity Controlled By Player Behavior
 * (minecraft:behavior.controlled_by_player)
...
export default interface MinecraftBehaviorControlledByPlayer {
   ...
   * "fractional_rotation_limit". A value of 0.0 will result in the
...
export enum MinecraftBehaviorControlledByPlayerControlFlags {
  jump = `jump`,
  look = `look`,
  move = `move`
}