 ...
 * 
 * Entity Behaviors Documentation - minecraft:behavior.dragonstrafeplayer
 * 
...
/**
 * Entity Dragonstrafeplayer Behavior
 * (minecraft:behavior.dragonstrafeplayer)
...
export enum MinecraftBehaviorDragonstrafeplayerControlFlags {
  jump = `jump`,
  look = `look`,
  move = `move`
}
