 ...
 * 
 * Entity Behaviors Documentation - minecraft:behavior.fertilize_farm_block
 * 
...
/**
 * Entity Fertilize Farm Block Behavior
...
export enum MinecraftBehaviorFertilizeFarmBlockControlFlags {
  jump = `jump`,
  look = `look`,
  move = `move`
}