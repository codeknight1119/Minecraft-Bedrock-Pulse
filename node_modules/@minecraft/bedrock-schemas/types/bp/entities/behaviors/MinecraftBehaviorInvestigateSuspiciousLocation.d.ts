 ...
 * 
 * Entity Behaviors Documentation - minecraft:behavior.investigate_suspicious_location
 * 
...
/**
 * Entity Investigate Suspicious Location Behavior
 * (minecraft:behavior.investigate_suspicious_location)
...
export enum MinecraftBehaviorInvestigateSuspiciousLocationControlFlags {
  jump = `jump`,
  look = `look`,
  move = `move`
}