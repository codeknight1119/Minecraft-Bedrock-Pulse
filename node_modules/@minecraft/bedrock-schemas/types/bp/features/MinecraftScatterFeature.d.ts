 ...
 * fail.
 * Note: In format version 1.21.20 and later, the `distribution` field
 * was introduced to consolidate scatter parameters. Prior versions use
 * x, y, z, iterations, and scatter_chance fields directly at the
 * root level of the feature.
 */
